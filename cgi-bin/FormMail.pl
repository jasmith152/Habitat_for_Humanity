...
BEGIN
{
  ...
  $postmaster        = 'postmaster@naturecoastdesign.net';
  @referers          = qw(habitatcc.org 50.28.18.106 localhost);
  @allow_mail_to     = qw(info@habitatcc.org webadmin@naturecoastdesign.net localhost);
  @recipients        = ();
  %recipient_alias   = ();
